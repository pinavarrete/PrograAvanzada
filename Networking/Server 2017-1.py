...
class Servidor:
    ...
    def __init__(self, usuario):
        ...
        # Debemos hacer el setup para poder escuchar a los clientes
    ...
    def recibir_mensajes(self):
        while True:
            try:
                ...
                elif mensaje['status'] == 'server_name':
                    old_user = self.usuario
                    self.usuario = mensaje['content']
                    print("""Se ha cambiado el nombre de {} a {} exitosamente
                          """.format(old_user, self.usuario))
    ...
    def aceptar(self):
        ...
        thread_cliente = threading.Thread(target=self.recibir_mensajes,
                                          args=())
    ...
    def enviar(self, mensaje):
        if self.cliente:
            msj_final = {'status': 'msg',
                         'content': self.usuario + ": " + mensaje}
